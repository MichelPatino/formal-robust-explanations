...
#chmod u+x abduction_algorithm/batch_lunarlander_deletion_algorithm.sh
#to execute:
#./abduction_algorithm/batch_lunarlander_deletion_algorithm.sh

######################################################################
# Modifiable parameters

# add the benchmark name
benchmark_name="lunarlander"
